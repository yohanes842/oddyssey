...
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js"); //Notification


var notification = $(".notification");
var close_notification = $("#close-btn-notification");
setTimeout(function () {
...
function moveLeft() {
  ...
  var last = $(".carousel-image-card").last();
  var current = $(".carousel-image-card").first().next();
  slideBox.animate({
    left: "0vw"
  }, 1000, "linear");
  setTimeout(function () {
...
function moveRight() {
  leftArrow.off("click", moveLeft);
  rightArrow.off("click", moveRight);
  var first = $(".carousel-image-card").first();
