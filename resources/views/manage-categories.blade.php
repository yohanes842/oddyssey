...
<div class="w-full flex flex-col items-center">
    <div class="m-10 hover:scale-105">
        <a class="p-3 bg-[#374151] text-white text-sm rounded-md font-medium cursor-pointer hover:scale-105 hover:bg-[#475161]" href="/admin/manage/games/addcategory">ADD NEW CATEGORY</a>
    </div>
    <div class="categories-list w-full flex flex-col gap-2 ">
        @if($categories->isEmpty())
            <h1 class="m-10 text-center">No Categories Added!</h1>
        @else
            @foreach($categories as $category)
                <div class="cat-box w-full p-5 flex justify-between items-center rounded-md bg-white">
